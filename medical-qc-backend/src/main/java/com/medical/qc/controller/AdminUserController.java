...
import com.medical.qc.service.AdminUserService;
...
public class AdminUserController {
    ...
    public ResponseEntity<?> getUsers(
        ...
        return ResponseEntity.ok(adminUserService.getUserPage(page, limit, keyword, role, active));
    }
    ...
    public ResponseEntity<?> updateUser(
        ...
        User currentUser = sessionUserSupport.requireAuthenticatedUser(session);
        sessionUserSupport.requireAdmin(currentUser);
        return ResponseEntity.ok(adminUserService.updateUser(currentUser.getId(), userId, request));
    }
}
