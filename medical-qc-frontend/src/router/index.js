  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: () => import('@/views/patient/QualityPatientManagement.vue'),
        meta: {
          requiresAuth: true,
          roles: ['doctor', 'admin'],
          taskType: 'head',
          pageTitle: 'CT头部平扫患者信息管理',
          pageDescription: '维护 CT 头部平扫任务的患者基础档案与检查号信息。',
      ...
      },
      {
        ...
        meta: {
          ...
          roles: ['doctor', 'admin'],
          taskType: 'hemorrhage',
          pageTitle: '头部出血检测患者信息管理',
          pageDescription: '维护头部出血检测患者档案，并与真实检测及 PACS 患者信息联动。',
      ...
      },
      {
        ...
        meta: {
          ...
          pageTitle: 'CT胸部平扫患者信息管理',
          pageDescription: '维护 CT 胸部平扫任务的患者基础档案与检查号信息。',
          workflowConnected: false,
        },
      },
      {
        ...
        meta: {
          ...
          pageTitle: 'CT胸部增强患者信息管理',
          pageDescription: '维护 CT 胸部增强任务的患者基础档案与检查号信息。',
          workflowConnected: false,
        },
      },
      {
        ...
        meta: {
          ...
          pageTitle: '冠脉CTA患者信息管理',
          pageDescription: '维护冠脉 CTA 任务的患者基础档案与检查号信息。',
          workflowConnected: false,
        },
      },
      {
